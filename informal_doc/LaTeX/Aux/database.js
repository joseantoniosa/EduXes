...
\emph { queryStudentsSuccess(tx, results) {
...
\emph { queryStudentsByGroupDB(tx) {
    ...
    tx.executeSql(sql, [], queryStudentsByGroupSuccess, dbErrorFunc = \emph {(tx, e) {
        if (tx.message)
            e = tx;
        log(sql);
...
\emph { queryReportAttendanceSuccess(tx, results) {
    var html = "";
    var id = 0;
    var name = "";
    var surname = "";
...
//
\emph { queryReportAttendanceDB(tx) {// report->Attendance->Group
...
\emph { queryStudentsByGroupSuccess(tx, results) {
    var len = results.rows.length;
 ...
 *
 */
\emph { queryScheduleSuccess(tx, results) {
    var len = results.rows.length;
    var html;
    var id=0;
    var description="";
