...
There are several objectives not fulfilled yet, but I am on the way to get those done, those are, in priority order:
\begin{itemize}
\item Add image to student.
...
%%> puideches acadar e cales non e porqué. Incluír neste apartado a
%%> descrición da aplicación desenvolvida, que é o que agora mesmo tés no
%%> capítulo 4.Description.
